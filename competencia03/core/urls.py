...
urlpatterns = [
    ...
    path("empresas/<int:empresa_id>/remover-membro/<str:user_id>/", views.remover_membro_empresa, name="remover_membro_empresa"),
    ...
    path("projetos/<int:id_projeto>/remover-membro/<str:id_usuario>/", views.remove_membro, name="remove_membro"),
    
    # Usuários (apenas superusuários)
    path("usuarios/", views.usuarios_list, name="usuarios_list"),
    path("usuarios/criar/", views.usuario_create, name="usuario_create"),
    path("usuarios/<str:id>/editar/", views.usuario_edit, name="usuario_edit"),
    path("usuarios/<str:id>/deletar/", views.usuario_delete, name="usuario_delete"),
]
